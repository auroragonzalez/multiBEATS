...
def evaluate_model(model:Model, dataset_id, dataset_fold_id=None, batch_size=128, test_data_subset=None,
                   cutoff=None, normalize_timeseries=False, startTime=0, mid_time=0, method=None):
    ...
    executionTime = (time.time() - startTime) + mid_time
    print ('Execution time in seconds: ' + str (executionTime))
    file1 = open("results_seq2var_lstmfcn.txt", "a")  # append mode
    file1.write(str(dataset_id) +";" +str(accuracy )+";"+str(executionTime)+';'+str(method)+"\n")
    file1.close()
