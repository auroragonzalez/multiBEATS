...
# Sliding windows: We create a unction that returns a list of indices of the data that we are going to consider for each matrix that we are going to compute the eigenvalues from (depending on the window size and the number of data we slide for each group)
