...
from keras.layers import Layer #keras.engine -> keras.layers
from keras.layers import InputSpec #keras.engine -> keras.layers
from keras.legacy import interfaces #keras.engine -> keras.layers
