...
from utils.new_constants import TRAIN_FILES, TEST_FILES, MAX_NB_VARIABLES, NB_CLASSES_LIST
...
def calculate_dataset_metrics(X_train):
    ...
    print('max_nb_variables: ', max_nb_variables)
...
def cutoff_sequence(X_train, X_test, choice, dataset_id, sequence_length):
    print(MAX_NB_VARIABLES[dataset_id])
